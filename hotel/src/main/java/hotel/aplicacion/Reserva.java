...
public class Reserva {
    ...
    /**
     * Calcula el coste de una reserva en funcióm de la cantidad de noche, del tipo de habitación, de si hay cama supletoria. Aplicar
     * un descuento si el cliente está más de 7 noches.
     * 
